...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-white to-fuchsia-50">
      {/* Header */}
      <div className="relative bg-gradient-to-r from-violet-500 to-fuchsia-500 overflow-hidden">
          ...
          <Card className="p-8 bg-white border border-slate-300 shadow-lg">
            ...
            {achievements.length === 0 ? (
              <div className="text-center py-16 bg-gradient-to-br from-slate-50 to-blue-50 rounded-xl border-2 border-blue-100">
                ...
                <Link href="/learn">
                  <Button className="bg-gradient-to-r from-violet-500 to-fuchsia-500 hover:from-violet-600 hover:to-fuchsia-600 text-white shadow-lg">
