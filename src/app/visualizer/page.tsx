...
const languageLabels: Record<CodeLanguage, string> = { c: "C", javascript: "JavaScript", python: "Python", java: "Java", cpp: "C++" };
...
export default function VisualizerPage() {
  ...
  const applyCustomArray = () => {
    ...
    // Use original values directly - no normalization
  ...
  const getBarColor = (state: ArrayBar["state"]) => {
    switch (state) {
      ...
      case "sorted": return "from-green-500 to-emerald-600";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-sky-50">
      ...
      <div className="relative z-10">
          ...
          <div className="max-w-[1800px] mx-auto px-4 py-4">
            <div className="flex items-center justify-between flex-wrap gap-4">
              ...
              <div className="flex items-center gap-2 bg-gray-100 p-1 rounded-xl border border-gray-200">
                <button onClick={() => setViewMode("algorithms")} className={cn("px-4 py-2 rounded-lg font-medium text-sm transition-all flex items-center gap-2", viewMode === "algorithms" ? "bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white shadow-md" : "text-gray-500 hover:text-gray-800")}>
                  <TrendingUp className="w-4 h-4" /><span className="hidden sm:inline">Algorithms</span>
                </button>
                <button onClick={() => setViewMode("datastructures")} className={cn("px-4 py-2 rounded-lg font-medium text-sm transition-all flex items-center gap-2", viewMode === "datastructures" ? "bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white shadow-md" : "text-gray-500 hover:text-gray-800")}>
        ...
        <AnimatePresence>
          {message && (
            <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="fixed top-20 left-1/2 transform -translate-x-1/2 z-50 px-6 py-3 bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white rounded-xl shadow-lg">
              {message}
            </motion.div>
          )}
        </AnimatePresence>
        ...
        {!isAuthenticated && (
          <div className="max-w-[1800px] mx-auto px-4 mt-4">
            <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-4 flex items-center justify-between shadow-sm">
              ...
              <Link href="/auth/signin" className="px-4 py-2 bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white rounded-lg font-medium hover:shadow-lg transition-all">
                Sign In
              </Link>
            </div>
          </div>
            ...
            {viewMode === "algorithms" ? (
                    ...
                    {customInputMode && (
                      <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }} className="space-y-3">
                        <div className="flex gap-2">
                          ...
                          <button onClick={applyCustomArray} className="px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-xl font-medium text-sm flex items-center gap-2 shadow-md">
                        ...
                        {(algorithm === "linear" || algorithm === "binary") && (
                          <div className="flex gap-2">
                            ...
                            <button onClick={applySearchTarget} className="px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-xl font-medium text-sm flex items-center gap-2 shadow-md">
                  ...
                  <div className="bg-white border border-gray-200 rounded-2xl p-4 shadow-sm">
                    <div className="flex flex-wrap items-center justify-between gap-4">
                      <div className="flex items-center gap-2">
                        ...
                        <button onClick={runAlgorithm} className={cn("p-4 rounded-xl text-white shadow-lg transition-all", isRunning && !isPaused ? "bg-gradient-to-r from-amber-500 to-orange-500" : "bg-gradient-to-r from-violet-500 to-fuchsia-500 hover:shadow-violet-400/25")}>
                      ...
                      <div className="flex items-center gap-4 text-xs flex-wrap">
                        <div className="flex items-center gap-2"><div className="w-3 h-3 rounded bg-gradient-to-r from-cyan-500 to-blue-500" /><span className="text-gray-500">Default</span></div>
                        ...
                        <div className="flex items-center gap-2"><div className="w-3 h-3 rounded bg-gradient-to-r from-green-500 to-emerald-600" /><span className="text-gray-500">Sorted</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <motion.div key="datastructures" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }}>
                <div className="flex items-center gap-2 mb-6 overflow-x-auto pb-2">
                  {([
                    { id: "stack" as const, name: "Stack", icon: Layers, color: "from-violet-500 to-fuchsia-500" },
                    ...
                    { id: "graph" as const, name: "Graph", icon: Network, color: "from-pink-500 to-rose-500" }
                  ]).map(ds => (
                          ...
                          <div className="flex gap-2 min-w-[300px] justify-center flex-wrap">
                            <AnimatePresence>
                              {queue.map((item, index) => (
                                <motion.div key={item.id} initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.5 }} className={cn("w-16 h-16 rounded-xl flex flex-col items-center justify-center text-white font-bold text-lg shadow-lg", index === 0 ? "bg-gradient-to-br from-violet-500 to-fuchsia-500" : index === queue.length - 1 ? "bg-gradient-to-br from-cyan-500 to-blue-500" : "bg-gradient-to-br from-gray-400 to-gray-500")}>
                                  {item.value}
                    ...
                    <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm">
                      ...
                      {dsType === "stack" && (
                        <div className="grid grid-cols-2 gap-2">
                          <button onClick={pushStack} className="px-4 py-3 bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white rounded-xl font-medium flex items-center justify-center gap-2 shadow-md">
                      ...
                      {dsType === "linkedlist" && (
                        <div className="space-y-2">
                          ...
                          <button onClick={insertAtIndex} className="w-full px-4 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-xl font-medium flex items-center justify-center gap-2 shadow-md">
                      ...
                      {dsType === "doublylinkedlist" && (
                        <div className="space-y-2">
                          ...
                          <button onClick={insertDoublyAtIndex} className="w-full px-4 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-xl font-medium flex items-center justify-center gap-2 shadow-md">
                            <MapPin className="w-4 h-4" />Insert at Index
                          </button>
                          <div className="grid grid-cols-2 gap-2">
                      ...
                      {dsType === "graph" && (
                        <div className="space-y-2">
                          <div className="grid grid-cols-2 gap-2">
                            <button onClick={addGraphNode} disabled={isTraversing} className="px-4 py-3 bg-gradient-to-r from-pink-500 to-rose-500 text-white rounded-xl font-medium flex items-center justify-center gap-2 shadow-md disabled:opacity-50">
