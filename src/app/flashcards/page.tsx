...
const categoryMeta: Record<string, { icon: React.ElementType; color: string }> = {
  'Arrays': { icon: Layers, color: 'from-sky-400 to-cyan-400' },
  'Linked Lists': { icon: GitBranch, color: 'from-sky-400 to-cyan-400' },
  'Stacks & Queues': { icon: Layers, color: 'from-orange-500 to-red-500' },
  'Trees': { icon: TreePine, color: 'from-green-500 to-emerald-500' },
  'Graphs': { icon: Network, color: 'from-emerald-400 to-teal-400' },
      ...
      <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-white py-8 px-4\">
        ...
        <AnimatePresence>
          {showSyncNotification && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -50 }}
              className="fixed top-4 right-4 z-50 px-4 py-3 rounded-xl bg-gradient-to-r from-emerald-400 to-teal-400 text-white font-medium shadow-lg"
            >
              {syncMessage}
            </motion.div>
          )}
        ...
        <div className="max-w-5xl mx-auto relative">
          ...
          <motion.button
            ...
            className="w-full bg-gradient-to-r from-emerald-400 to-teal-400 rounded-xl p-6 mb-6 text-left hover:opacity-90 transition-opacity"
          >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-white py-8 px-4">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none opacity-50">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-sky-200 rounded-full blur-3xl" />
      </div>
      ...
      <div className="max-w-3xl mx-auto relative">
        ...
        >
          ...
          >
            ...
            <div
              className={cn(
                "absolute inset-0 min-h-[400px] bg-gradient-to-br from-sky-50 to-cyan-50 border-2 border-sky-300 rounded-2xl p-8 shadow-xl",
                !isFlipped && "invisible"
              )}
